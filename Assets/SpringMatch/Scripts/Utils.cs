...
public class Utils
{
	public static void AlignCollider(CapsuleCollider collider, Vector3 pos0, Vector3 pos1, float height, float sizeOffset) {
		var s = collider.height;
		s = (pos0 - pos1).magnitude + sizeOffset;
		collider.height = s;
